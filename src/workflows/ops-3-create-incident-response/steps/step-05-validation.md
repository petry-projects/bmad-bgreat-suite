...
"Your Incident Response Plan is complete and saved to `{ops_artifacts}/incident-response.md`.
...
2. Set up alerting tied to severity levels (use `ops-3-create-observability` workflow)
