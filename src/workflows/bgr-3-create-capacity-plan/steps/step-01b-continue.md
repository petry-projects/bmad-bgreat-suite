...
Read the existing capacity plan document completely and analyze:
...
- What capacity decisions have been made
...
"Welcome back {{user_name}}! I found your Capacity Planning work.
...
- Confirm: "This will delete all existing capacity planning work. Are you sure? (y/n)"
...
- Ask user: "The capacity plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-growth-modeling.md`
- `./step-03-scaling-strategy.md`
- `./step-04-validation-testing.md`
