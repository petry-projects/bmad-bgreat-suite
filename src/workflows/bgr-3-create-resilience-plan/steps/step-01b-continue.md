...
Read the existing resilience testing plan document completely and analyze:
...
- What resilience testing decisions have been made
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `./step-04-game-day-planning.md`
...
- Confirm: "This will delete all existing resilience testing plan work. Are you sure? (y/n)"
...
- Ask user: "The resilience testing plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
