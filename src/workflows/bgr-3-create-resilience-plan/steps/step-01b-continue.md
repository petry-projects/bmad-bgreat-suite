...
Read the existing resilience plan document completely and analyze:
...
- `maturityLevel`: Resilience maturity level assessed at init
- `createdDate`, `lastUpdated`: Timeline context

**Content Analysis:**

- What sections exist in the document
- What resilience decisions have been made (steady-state hypotheses defined, failure scenarios designed, experiments planned)
...
"Welcome back {{user_name}}! I found your Resilience Testing Plan work.

**Current Progress:**

- Steps completed: {{stepsCompleted list}}
- Last step worked on: Step {{lastStep}}
- Resilience maturity level: {{maturityLevel}}
...
- Example: If `stepsCompleted: [1, 2]`, load `./step-03-failure-scenarios.md`
...
- Confirm: "This will delete all existing resilience plan decisions. Are you sure? (y/n)"
...
- Ask user: "The resilience plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-steady-state.md`
- `./step-03-failure-scenarios.md`
- `./step-04-game-day.md`
