...
Read the existing chaos game day plan document completely and analyze:
...
- What experiments and hypotheses have been defined
- What blast radius controls and safety gates are defined
...
"Welcome back {{user_name}}! I found your Chaos Game Day work.
...
- Example: If `stepsCompleted: [1, 2]`, load `./step-03-blast-radius-safety.md`
...
- Confirm: "This will delete all existing chaos game day decisions. Are you sure? (y/n)"
...
- Ask user: "The chaos game day plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-hypothesis-design.md`
- `./step-03-blast-radius-safety.md`
- `./step-04-execution-observation.md`
