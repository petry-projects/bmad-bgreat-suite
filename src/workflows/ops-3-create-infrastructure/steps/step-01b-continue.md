...
Read the existing infrastructure document completely and analyze:
...
- What infrastructure decisions have been made
...
"Welcome back {{user_name}}! I found your Infrastructure work.
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `./step-04-container-strategy.md`
...
- Confirm: "This will delete all existing infrastructure decisions. Are you sure? (y/n)"
...
- Ask user: "The infrastructure plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-iac-strategy.md`
- `./step-03-environment-strategy.md`
- `./step-04-container-strategy.md`
