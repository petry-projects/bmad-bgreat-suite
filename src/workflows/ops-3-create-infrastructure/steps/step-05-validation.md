...
- Append validation results and implementation sequence to `{ops_artifacts}/infrastructure.md`
...
"Your Infrastructure Plan has been finalized and saved to `{ops_artifacts}/infrastructure.md`.
