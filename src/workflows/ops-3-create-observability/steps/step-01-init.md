...
- Look for existing {ops_artifacts}/`*observability*.md`
...
Copy the template from `../templates/observability-plan-template.md` to `{ops_artifacts}/observability.md`
...
- Created: `{ops_artifacts}/observability.md` from template
