...
Read the existing observability document completely and analyze:
...
- What observability decisions have been made
...
"Welcome back {{user_name}}! I found your Observability work.
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `./step-04-slo-alert-framework.md`
...
- Confirm: "This will delete all existing observability work. Are you sure? (y/n)"
...
- Ask user: "The observability plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-current-state.md`
- `./step-03-design-instrumentation.md`
- `./step-04-slo-alert-framework.md`
