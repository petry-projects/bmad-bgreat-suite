...
- Append the validation and implementation content to `{ops_artifacts}/observability.md`
- Update frontmatter:
...
- Save the final content to `{ops_artifacts}/observability.md`
...
"The Observability Plan for {{project_name}} is complete and saved to `{ops_artifacts}/observability.md`.
