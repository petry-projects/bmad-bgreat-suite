...
Read the existing disaster recovery document completely and analyze:
...
- What DR decisions have been made
...
"Welcome back {{user_name}}! I found your Disaster Recovery work.
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `./step-04-failover-procedures.md`
...
- Confirm: "This will delete all existing disaster recovery work. Are you sure? (y/n)"
...
- Ask user: "The disaster recovery plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-rto-rpo-analysis.md`
- `./step-03-backup-restore-strategy.md`
- `./step-04-failover-procedures.md`
