...
Read the existing compliance map document completely and analyze:
...
- What compliance decisions have been made
...
"Welcome back {{user_name}}! I found your Compliance Mapping work.
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `./step-04-gap-analysis.md`
...
- Confirm: "This will delete all existing compliance mapping work. Are you sure? (y/n)"
...
- Ask user: "The compliance map looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-03-control-mapping.md`
- `./step-04-gap-analysis.md`
