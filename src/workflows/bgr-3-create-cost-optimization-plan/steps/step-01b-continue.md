...
Read the existing cost optimization plan document completely and analyze:

**Frontmatter Analysis:**

- `stepsCompleted`: What steps have been done
- `inputDocuments`: What documents were loaded
- `lastUpdated`: When was the last update
- `status`: Current document status

**Content Analysis:**

- What sections exist in the document
- What optimization decisions have been made
...
"Welcome back {{user_name}}! I found your Cost Optimization Plan work.
...
- Identify the next step based on `stepsCompleted` using the routing table:
  ...
  |------------------|-----------|
  | `[]` (empty) | `./step-02-resource-rightsizing.md` |
  | `[1]` | `./step-02-resource-rightsizing.md` |
  | `[1, 2]` | `./step-03-purchase-strategy.md` |
  | `[1, 2, 3]` | `./step-04-tagging-anomaly-budget.md` |
  | `[1, 2, 3, 4]` | `./step-05-validation.md` |
  | `[1, 2, 3, 4, 5]` | Workflow complete — present completion summary |

- If `stepsCompleted` contains an unexpected or malformed array, default to `./step-02-resource-rightsizing.md` and inform the user of the reset
...
- Confirm: "This will delete all existing cost optimization planning work. Are you sure? (y/n)"
...
- Update frontmatter `lastUpdated` to reflect current navigation
...
- Ask user: "The cost optimization plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-resource-rightsizing.md`
- `./step-03-purchase-strategy.md`
- `./step-04-tagging-anomaly-budget.md`
