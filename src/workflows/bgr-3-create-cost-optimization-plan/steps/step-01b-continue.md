...
- What cost optimization decisions have been made
...
- Identify the next step based on `stepsCompleted` using the routing table:
  ...
  |------------------|-----------|
  | `[]` (empty) | `./step-02-cost-baseline.md` |
  | `[1]` | `./step-02-cost-baseline.md` |
  | `[1, 2]` | `./step-03-optimization-strategy.md` |
  | `[1, 2, 3]` | `./step-04-governance.md` |
  | `[1, 2, 3, 4]` | `./step-05-validation.md` |
  | `[1, 2, 3, 4, 5]` | Workflow complete — present completion summary |

- If `stepsCompleted` contains an unexpected or malformed array, default to `./step-02-cost-baseline.md` and inform the user of the reset
...
- `./step-02-cost-baseline.md`
- `./step-03-optimization-strategy.md`
- `./step-04-governance.md`
