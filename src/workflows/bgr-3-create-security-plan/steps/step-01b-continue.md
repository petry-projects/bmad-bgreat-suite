...
Read the existing security plan document completely and analyze:
...
- What security decisions have been made
...
"Welcome back {{user_name}}! I found your Security Plan work.
...
- Example: If `stepsCompleted: [1, 2]`, load `./step-03-security-controls.md`
...
- Confirm: "This will delete all existing security planning decisions. Are you sure? (y/n)"
...
- Ask user: "The security plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-03-security-controls.md`
- `./step-04-compliance-mapping.md`
