...
Read the existing incident response document completely and analyze:
...
- What incident response decisions have been made
...
"Welcome back {{user_name}}! I found your Incident Response work.
...
- Example: If `stepsCompleted: [1, 2]`, load `./step-03-response-procedures.md`
...
- Confirm: "This will delete all existing incident response decisions. Are you sure? (y/n)"
...
- Ask user: "The incident response plan looks complete! Should I mark this workflow as finished, or is there more you'd like to work on?"
...
- `./step-02-severity-classification.md`
- `./step-03-response-procedures.md`
- `./step-04-runbooks-postmortems.md`
