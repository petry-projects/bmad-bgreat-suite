...
|------|-------------|-------|
| CO | Guided workflow to define metrics, logging, tracing, dashboards, SLOs, and alerting strategy | ops-3-create-observability |
| CR | Guided workflow to define severity classification, runbooks, on-call procedures, and postmortems | ops-3-create-incident-response |
