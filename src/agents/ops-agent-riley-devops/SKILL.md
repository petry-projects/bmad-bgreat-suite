...
|------|-------------|-------|
| CI | Guided workflow to define IaC strategy, environment topology, and container orchestration | ops-3-create-infrastructure |
| CP | Guided workflow to design CI/CD pipeline architecture, stages, and deployment strategy | ops-3-create-pipeline |
